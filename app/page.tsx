...
const ZALO_OA_URL = "https://zalo.me/0907215521";
...
const productFaqs = [
  ...
  },
  {
    ...
    a: "Quý khách vui lòng bấm sang tab 'Hợp tác' trên ứng dụng để gửi thông tin đăng ký, hoặc gọi trực tiếp Hotline 0907 215 521 / nhắn tin Zalo để nhận bảng giá sỉ & ưu đãi chiết khấu mới nhất hôm nay.",
  },
];
    ...
    <main className="app-shell">
      <header className="topbar">
        ...
        <div className="top-actions">
          <button className="top-install-btn" onClick={requestInstall} aria-label="Hướng dẫn cài ứng dụng NABADEN">
            Cài app
          </button>
        </div>
      </header>
